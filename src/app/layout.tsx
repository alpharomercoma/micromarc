...
export const metadata: Metadata = {
  ...
  description: "Visual-Qwen consists of a frozen CLIP ViT-G/14 vision encoder and a Whisper V3 Turbo audio transcription module, a lightweight Query-Former (Q-Former), and a frozen Qwen3-4B large language model.",
  ...
  openGraph: {
    images: ["/images/theoretical_framework.png"],
    title: "Visual-Qwen: Augmenting Multimodal Deep Learning with Attention Mechanisms to Recognize 'Sludge Content' from Short Form Videos",
    description: "Visual-Qwen consists of a frozen CLIP ViT-G/14 vision encoder and a Whisper V3 Turbo audio transcription module, a lightweight Query-Former (Q-Former), and a frozen Qwen3-4B large language model.",
    siteName: "Visual-Qwen",
    type: "website",
    url: "https://micromarc.me",
  },
};
